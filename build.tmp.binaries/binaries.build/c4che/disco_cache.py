...
CXX_TGT_F = ['-c', '-o']
DEBUG = False
DEFINES = ['SKETCHBOOK="/home/jack/git/ArduSub"', 'CONFIG_HAL_BOARD=HAL_BOARD_LINUX', 'CONFIG_HAL_BOARD_SUBTYPE=HAL_BOARD_SUBTYPE_LINUX_DISCO']
DEFINES_ST = '-D%s'
...
cfg_files = ['/home/jack/git/ArduSub/build.tmp.binaries/binaries.build/disco/ap_config.h']
cprogram_PATTERN = '%s'
